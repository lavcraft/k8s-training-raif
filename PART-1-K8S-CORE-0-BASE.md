...
1. **Задание **\*: В каких ситуациях может измениться `CURRENT` значение в списке `kubectl get rs`, назовите хотя бы две и поясните какие из них наиболее реальны в ваших условиях
